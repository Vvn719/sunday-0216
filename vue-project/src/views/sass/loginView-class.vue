<template>
  <div class="login">
    <n-config-provider :theme-overrides="themeOverrides">
      <div class="card">
        <n-card>
          <n-tabs default-value="login" size="large" justify-content="space-evenly" :ref="tabs">
            <n-tab-pane name="login" tab="登入">
              ...
              <n-button type="primary" block secondary strong @click="login">登入</n-button>
            </n-tab-pane>
            ...
            <n-tab-pane name="register" tab="註冊">
              <n-form ref="valid" :model="form" :rules="rules">
                ...
                <n-form-item-row label="會員名稱" path="name">
                  <n-input v-model:value="form.name" placeholder="輸入會員名稱" />
                </n-form-item-row>

                <n-form-item-row label="電子信箱" path="email">
                  <n-input v-model:value="form.email" placeholder="輸入電子信箱" @keydown.enter.prevent />
                </n-form-item-row>

                <n-form-item-row label="手機號碼" path="cellPhone">
                  <n-input v-model:value="form.cellPhone" placeholder="輸入手機號碼" @keydown.enter.prevent />
                </n-form-item-row>
              ...
              <n-button type="primary" block secondary strong @click="register" :loading="loading">註冊</n-button>
            </n-tab-pane>
          </n-tabs>
        </n-card>
      </div>
